		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse"
					data-target=".nav-collapse"> <span class="label label-important"
					id="nbAll"></span> <span class="icon-bar"></span> <span
					class="icon-bar"></span> <span class="icon-bar"></span>
				</a> <a class="brand" href="#">Mes Web TV</a>
				<div class="nav-collapse">
					<ul class="nav">
						<li class="dropdown" id="menu1"><a class="dropdown-toggle"
							data-toggle="dropdown" href="#menu1"> Chaines 1 <span
								style="display: none;" class="label label-important"
								id="nbChaines"></span> <b class="caret"></b>
						</a>
							<ul class="dropdown-menu" id="chaines">
							</ul>
						</li>
						<li class="dropdown" id="menu2"><a class="dropdown-toggle"
							data-toggle="dropdown" href="#menu2"> Chaines 2 <span
								style="display: none;" class="label label-important" id="nbHub"></span>
								<b class="caret"></b>
						</a>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span12">
				<div class="hero-unit">
					...
					<p>
						<a class="btn btn-primary btn-large" onclick="stop()"><i
							class="icon-stop icon-white"></i> Stop </a>
		...
		<footer>
			<a href="http://www.adobe.com/go/getflashplayer" target="_blank"><img
				alt="Download flash" src="Flash_Player.jpg"> </a> <a
				href="http://affiliates.mozilla.org/link/banner/8294"
				target="_blank"> <img src="ff.png"
				alt="Télécharger : facile, amusant, génial"></img>
			</a>
